namespace Project.MainPages
{
    partial class PaymentPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            sort_combo.Items.AddRange(new object[] { "ID", "TimeStamp", "Payment Type", "Total" });
            ...
            Name = "PaymentPage";
            Text = "PaymentPage";
            FormClosing += PaymentPage_FormClosing;
